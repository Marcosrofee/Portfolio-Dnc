     ...
     <section >
         ...
         <div className="about-container">
             <h1>Vamos trabalhar <br /> juntos</h1> 
                 <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. <br /> Dolore, fuga saepe <br />architecto officia, </p>
                 ...
                 <div className="about-icon">
                     ...
                     <p>Endereço <br />
                     Rua Luis R Fernandes Vincentes</p>
                 </div>
         </div>
            <div className="about-box">
                <h4>Entre  em contato <span>comigo</span></h4>
                <form action="">
